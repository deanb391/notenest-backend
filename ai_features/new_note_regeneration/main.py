...
def main(notes):
    ...
    try:
        ...
        found_knowledge_expansion = False
        ...
        for chunk in all_chunks:
            ...
            if cached_expansion != "None":
                found_knowledge_expansion = True
                ...
                regen_user_prompt = regeneration_user_prompt(chunk_text, chunk_token, cached_expansion)
            ...
            try:
                ...
                try:
                    ...
                    if label == "Explanation":          
                        explanation_token_count += chunk_token
        ...
        try:
            ...
            regen_system_prompt = regeneration_system_prompt
        ...
        print(f"Couldn't get content from the database. Error: {e}")
    ...
    try:      
        ...
        print(f"There was an error regenerating the chunks. Error {e}")
